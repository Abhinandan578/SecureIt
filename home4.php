  ...
  <div class="container-fluid" style="margin-top:0px;" id="navi3">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav" id ="navy">
        ...
        <li id="inst1"><a href="insert.php">MY ACCOUNT</a></li> 
        <li id="security1"><a href="random_password.php">PASSWORD GENERATOR</a></li> 
      </ul>
...
<div id="demo" style="left:40%;top:40%;position:fixed;visibility:hidden;">
  <span style="position:fixed; width:1.5%;height:2.5%;" onclick="document.getElementById('demo').style.visibility='hidden'" class="glyphicon glyphicon-remove" id="add"></span>
<iframe id="myframe" name="myframe" src="#" width=100% height=100% style="background-color: white;top:40%;right:60%;"></iframe>
</div>
<?php
...
if($cnt>0){
  ...
  echo "<div>";
    while($cnt--){
      ...
      echo "<div class='col-sm-2' style='float:left;padding-bottom:25px;background-color:#233736;color:white;margin:25px;'><table style='color:white;'><tr><td>URL:</td><td>";
      echo $table["url"];
