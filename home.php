...
$(document).ready(function(){
    $('.btn').popover({title: "<form action='fill_site_detail.php' method='post' target='myframe'> <table id='list'><tr><td><button type='submit' name='1' value='www.amazon.in' onclick='myFunction()' >AMAZON</td></tr><tr><td><button type='submit' name='1' value='www.facebook.com' onclick='myFunction()' >FACEBOOK</button></td></tr><tr><td><button type='submit' name='1' value='www.github.com' onclick='myFunction()' >GITHUB</button></td></tr><tr><td><button type='submit' name='1' value='www.gmail.com' onclick='myFunction()' >GMAIL</button></td></tr><tr><td><button type='submit' name='1' value='www.yahoo.com' onclick='myFunction()' >YAHOO</button></td></tr><tr><td><button type='submit' name='1' value='www.instagram.com' onclick='myFunction()' >INSTAGRAM</button><tr><td><button type='submit' name='1' value='signin.ebay.in' onclick='myFunction()' >EBAY</a></td><tr><td><button type='submit' name='1' value='www.tumblr.com' onclick='myFunction()' >TUMBLR</a></td></tr></tr></td></tr></table></form>", html: true, placement: "top"}); 
});
</script>
